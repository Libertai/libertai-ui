        ...
        <q-card class="col-12" flat>
          ...
          <q-card-section>
            <p>
              ...
              with tangible benefits? Look no further than Libertai Points! These points play an essential role within
              the exciting and innovative Aleph.im ecosystem.
            </p>
        ...
        <q-card :class="$q.screen.gt.sm ? 'col-6 text-center column' : 'text-center'" flat>
          ...
          <q-card-section class="q-pt-none bg-purple-50 col-grow">
            <p>
              ...
              cloud technology, you earn Libertai Points that reflect your trust in the platform.
            </p>
          </q-card-section>
        </q-card>
        <q-card :class="$q.screen.gt.sm ? 'col-6 text-center column' : 'text-center'" flat>
          ...
          <q-card-section class="q-pt-none bg-purple-50 col-grow">
            <p>
              ...
              interactions and enjoy the perks of being a node operator with Libertai Points as your reward!
            </p>
          </q-card-section>
        </q-card>
        <q-card :class="$q.screen.gt.sm ? 'col-6 text-center column' : 'text-center'" flat>
