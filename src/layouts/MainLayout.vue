    ...
    >
      ...
      <q-list style="flex-grow: 1">
        ...
        <q-item
          ...
          <q-item-section side>
            <q-btn v-if="route.params?.id == chat.id"
              flat icon="img:icons/msg_active.svg" size="sm" class="q-pa-xs">
            </q-btn>
            <q-btn v-if="route.params?.id != chat.id"
              flat icon="img:icons/msg.svg" size="sm" class="q-pa-xs">
            </q-btn>
          </q-item-section>
      ...
      <q-list class="q-pt-md">
        ...
        <q-item href="https://aleph.im" target="_blank">
          <q-item-section avatar>
            <img src="icons/aleph.svg" alt="Aleph" />
          </q-item-section>
